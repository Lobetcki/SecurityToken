package com.example.securitytoken.config;

import com.example.securitytoken.filter.UUIDAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain configureSecurityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeRequests()
                .antMatchers("/indications/authority").permitAll()
                .antMatchers("/indications/avg/{serial}").permitAll()
