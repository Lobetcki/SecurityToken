package com.example.securitytoken.service;
...
public class IndicationService {
    ...
    public IndicationService(IndicationRepository indicationRepository, SerialSecretRepository serialSecretRepository, TokenRepository tokenRepository) {
